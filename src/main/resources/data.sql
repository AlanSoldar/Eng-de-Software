...
CREATE TABLE INTERESSE (
  ...
  PRODUTO_ID INT NOT NULL,
  PRIMARY KEY (DONO_ID, INTERESSADO_ID, PRODUTO_ID),
  FOREIGN KEY (INTERESSADO_ID) REFERENCES USUARIO(ID),
  FOREIGN KEY (DONO_ID) REFERENCES USUARIO(ID),
  FOREIGN KEY (PRODUTO_ID) REFERENCES PRODUTO(ID)
);

INSERT INTO INTERESSE (DONO_ID, INTERESSADO_ID, PRODUTO_ID) VALUES
(1,2,2),
(2,1,3);